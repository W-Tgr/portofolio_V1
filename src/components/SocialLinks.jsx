...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/wilbert-tegar-771178382/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@wilberttgr",
    icon: Instagram,
    url: "https://www.instagram.com/wilberttgr/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@wilberttgr",
    icon: Youtube,
    url: "https://www.youtube.com/@wilberttegar",
    color: "#FF0000",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@wilbrtt?_t=ZS-8zwIrjmVfS1&_r=1",
    color: "black",
...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-[#161b22]/80 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3
        className="text-xl font-semibold text-[#f0f6fc] mb-6 flex items-center gap-2"
        data-aos="fade-down" 
      >
        <span className="inline-block w-8 h-1 bg-[#2188ff] rounded-full"></span>
        Connect With Me
      </h3>
      ...
      <div className="flex flex-col gap-4">
        ...
        <a
          ...
          className="group relative flex items-center justify-between p-4 rounded-lg 
                     bg-[#0d1117]/80 border border-[#30363d] overflow-hidden
                     hover:border-[#2188ff]/50 transition-all duration-500"
          data-aos="fade-up"
          data-aos-delay="100" 
        >
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold pt-[0.2rem] text-[#f0f6fc] tracking-tight leading-none group-hover:text-[#f0f6fc] transition-colors duration-300">
                {linkedIn.displayName}
              </span>
              <span className="text-sm text-[#8b949e] group-hover:text-[#8b949e] transition-colors duration-300">
                {linkedIn.subText}
              </span>
            </div>
          </div>
          ...
          {/* External Link */}
          <ExternalLink
            className="relative w-5 h-5 text-[#8b949e] group-hover:text-[#f0f6fc]
          ...
          <div className="absolute inset-0 opacity-0 group-hover:opacity-100 pointer-events-none overflow-hidden">
            <div
              className="absolute inset-0 bg-gradient-to-r from-transparent via-[#2188ff]/10 to-transparent
          ...
          {[instagram, youtube].map((link, index) => (
            ...
            >
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-sm font-bold text-[#f0f6fc] group-hover:text-[#f0f6fc] transition-colors duration-300">
                  {link.displayName}
                </span>
                <span className="text-xs text-[#8b949e] truncate group-hover:text-[#8b949e] transition-colors duration-300">
                  {link.subText}
                </span>
              </div>

              <ExternalLink
                className="w-4 h-4 text-[#8b949e] group-hover:text-[#f0f6fc] ml-auto
                                       opacity-0 group-hover:opacity-100 transition-all duration-300
